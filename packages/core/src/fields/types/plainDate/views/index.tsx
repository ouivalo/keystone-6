...
function validate(value: Value, fieldMeta: PlainDateFieldMeta, label: string): string | undefined {
...
export type PlainDateFieldMeta = {
  defaultValue: string | null;
  isRequired: boolean;
};

export const controller = (
  config: FieldControllerConfig<PlainDateFieldMeta>
): FieldController<Value, string> & { fieldMeta: PlainDateFieldMeta } => {
  return {
    path: config.path,
    label: config.label,
