import { BaseStandardListTypeInfo, KeystoneContext } from '@keystone-6/core/types';
...
export type AuthConfig<ListTypeInfo extends BaseStandardListTypeInfo> = {
...
export type InitFirstItemConfig<ListTypeInfo extends BaseStandardListTypeInfo> = {
