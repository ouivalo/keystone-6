  ...
  hooks: {
    beforeOperation: args => {
      if (args.operation === 'delete') {
        if (args.item.name === 'trigger before delete') {
          throw new Error('Simulated error: beforeOperation');
        }
      } else {
        if (args.resolvedData?.name === 'trigger before') {
          throw new Error('Simulated error: beforeOperation');
        }
      }
    },
    afterOperation: args => {
      if (args.operation === 'delete') {
        if (args.originalItem.name === 'trigger after delete') {
          throw new Error('Simulated error: afterOperation');
        }
      } else {
        if (args.resolvedData?.name === 'trigger after') {
          throw new Error('Simulated error: afterOperation');
        }
      }
    },
  ...
  fields: {
    title: text({
      hooks: {
        beforeOperation: args => {
          if (args.operation === 'delete') {
            if (args.item.title === 'trigger before delete') {
              throw new Error('Simulated error: title: beforeOperation');
            }
          } else {
            if (args.resolvedData?.title === 'trigger before') {
              throw new Error('Simulated error: title: beforeOperation');
            }
          }
        },
        afterOperation: args => {
          if (args.operation === 'delete') {
            if (args.originalItem.title === 'trigger after delete') {
              throw new Error('Simulated error: title: afterOperation');
            }
          } else {
            if (args.resolvedData?.title === 'trigger after') {
              throw new Error('Simulated error: title: afterOperation');
            }
          }
        },
    ...
    content: text({
      hooks: {
        beforeOperation: args => {
          if (args.operation === 'delete') {
            if (args.item.content === 'trigger before delete') {
              throw new Error('Simulated error: content: beforeOperation');
            }
          } else {
            if (args.resolvedData?.content === 'trigger before') {
              throw new Error('Simulated error: content: beforeOperation');
            }
          }
        },
        afterOperation: args => {
          if (args.operation === 'delete') {
            if (args.originalItem.content === 'trigger after delete') {
              throw new Error('Simulated error: content: afterOperation');
            }
          } else {
            if (args.resolvedData?.content === 'trigger after') {
              throw new Error('Simulated error: content: afterOperation');
            }
          }
        },
